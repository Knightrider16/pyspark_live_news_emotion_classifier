# app_sklearn_full_real_time_fixed.py
...
st.markdown(
    "Predicting emotions of live news headlines using pre-trained Spark ML model converted to Python!"
)
...
fig_bar = px.bar(counts, x='emotion', y='count', color='emotion', color_discrete_map=color_map, title="Emotion Counts")
